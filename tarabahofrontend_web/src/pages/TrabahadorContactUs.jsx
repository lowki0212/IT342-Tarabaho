...
import "../styles/Trabahador-contact-us.css"
...
const TrabahadorContactUs = () => {
  ...
  return (
    <div className="Trabahador-contact-page-container">
      {/* NAVIGATION BAR */}
      <TrabahadorNavbar />

      {/* MAIN CONTENT */}
      <div className="Trabahador-contact-content">
        <div className="Trabahador-contact-left">
          <h1 className="Trabahador-contact-heading">CONTACT US</h1>
          <p className="Trabahador-contact-description">
          ...
          <div className="Trabahador-contact-info">
            <div className="Trabahador-contact-item">
        ...
        <div className="Trabahador-contact-right">
          <div className="Trabahador-contact-form-container">
            <h2 className="Trabahador-form-heading">We'd love to hear from you!</h2>

            <form onSubmit={handleSubmit} className="Trabahador-contact-form">
              <div className="Trabahador-form-group">
              ...
              <div className="Trabahador-form-row">
                <div className="Trabahador-form-group">
                  <label htmlFor="email">
              ...
              <button type="submit" className="Trabahador-send-button" disabled={isSubmitting || submitSuccess}>
