...
public class SecurityConfig {
	...
	public CorsConfigurationSource corsConfigurationSource() {
		...
		config.setAllowedOrigins(Arrays.asList("http://localhost:5173", "https://it-342-tarabaho-8q1h-89v462nt1-jilus-projects.vercel.app","https://it-342-tarabaho-8q1h-1sjnj79pj-jilus-projects.vercel.app")); // Update for production
